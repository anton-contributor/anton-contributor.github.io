...
function saveProject(content) {
    ...
    if (!projectNameInput.value) alert('Project name is empty');
        ...
        HISTORY.push({
            "data": [{
                ...
                "wallData": [{
                    ...
                    "coords": [{"x": 550, "y": 724}, {"x": 530, "y": 744}, {"x": 1090, "y": 744}, {
                        "x": 1070,
                        "y": 724
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1070, "y": 724}, {"x": 1090, "y": 744}, {"x": 1090, "y": 184}, {
                        "x": 1070,
                        "y": 204
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1070, "y": 204}, {"x": 1090, "y": 184}, {"x": 530, "y": 184}, {
                        "x": 550,
                        "y": 204
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
        ...
        HISTORY.push({
            "data": [{
                ...
                "wallData": [{
                    ...
                    "coords": [{"x": 457, "y": 734}, {"x": 437, "y": 754}, {"x": 1357, "y": 754}, {
                        "x": 1337,
                        "y": 734
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1337, "y": 734}, {"x": 1357, "y": 754}, {"x": 1357, "y": 134}, {
                        "x": 1337,
                        "y": 154
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1337, "y": 154}, {"x": 1357, "y": 134}, {"x": 1010, "y": 134}, {
                        "x": 1030,
                        "y": 154
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1030, "y": 154}, {"x": 1010, "y": 134}, {"x": 1010, "y": 448}, {
                        "x": 1030,
                        "y": 468
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
                    ...
                    "coords": [{"x": 1030, "y": 468}, {"x": 1010, "y": 448}, {"x": 437, "y": 448}, {
                        "x": 457,
                        "y": 468
                    }],
                    "graph": {"0": {}, "context": {}, "length": 1}
...
function importPlan() {
    ...
    reader.onload = function (event) {
        try {
            var fileReaderEventTarget = event.target
            var projectData = JSON.parse(fileReaderEventTarget.result);

            localStorage.setItem('history', JSON.stringify(projectData));
            const projectNameInput = document.getElementById('projectNameInput');
            projectNameInput.value = fileName.replace(/\.[^/.]+$/, '');
...
function save(boot = false) {
    ...
    if (HISTORY[HISTORY.length - 1] && JSON.stringify({
        objData: OBJDATA,
        wallData: WALLS,
        roomData: ROOM
    }) == JSON.stringify(JSON.parse(HISTORY[HISTORY.length - 1]).data[current_active_floor])) {
    ...
    if (!historyTemp) {
        ...
        for (var k in historyTemp.objData) {
            ...
            var obj = new editor.obj2D(OO.family, OO.class, OO.type, {
                x: OO.x,
                y: OO.y
            }, OO.angle, OO.angleSign, OO.size, OO.hinge = 'normal', OO.thick, OO.value, fill);
            obj.limit = OO.limit;
            ...
            if (ROOM[k].name == "") {
                ...
                if (ROOM[k].name == "Salon") {
                    ...
                    if (roomEnergy[k].light == 0) {
                        reportRoom += '<p><i class="fa fa-exclamation-triangle" style="color:orange" aria-hidden="true"></i> This room must have at least <b> 1 controlled light point </b> <small>(currently ' + roomEnergy[k].light + ')</small>.</p>\n';
                        nfc = false;
                    }
                    if (roomEnergy[k].plug < 5) {
                        reportRoom += '<p><i class="fa fa-exclamation-triangle" style="color:orange" aria-hidden="true"></i> This room must have at least <b> 5 power outlets</b> <small>(currently ' + roomEnergy[k].plug + ')</small>.</p>\n';
                        nfc = false;
                    }
...
for (var k = 0; k < textEditorColorBtn.length; k++) {
    textEditorColorBtn[k].addEventListener('click', function () {
        ...
        if (typeof binder !== 'undefined' && binder && binder.obj && (binder.obj.class == "text" || binder.obj.fill) && binder.obj.value) {
            ...
            binder.update();
            if (binder.obj.graph.context.children) {
                binder.obj.graph.context.children[0].setAttribute('fill', this.style.color);
            }
...
function carpentryCalc(classObj, typeObj, sizeObj, thickObj, dividerObj = 10, fill) {
    ...
    if (classObj == 'energy') {
        ...
        if (typeObj == 'bed') {
            construc.push({
                'path': "m " + (-sizeObj / 2) + "," + (-thickObj / 2) + " l " + (sizeObj) + ",0 l0," + (thickObj) + " l" + (-sizeObj) + ",0 Z",
                'fill': fill,
                'stroke': "#333",
                'strokeDashArray': ''
            });
    ...
    if (classObj == 'roof') {
        WALLS.push({
            ...
            "end": {"x": 540, "y": 734},
            "type": "normal",
            "parent": Math.round(Math.random() * 500),
            "child": 1,
            "angle": 1.5707963267948966,
            ...
            "child": 3,
            "angle": -1.5707963267948966,
            "equations": {"up": {"A": "v", "B": 1070}, "down": {"A": "v", "B": 1090}, "base": {"A": "v", "B": 1080}},
            ...
            "roof": true,
            "thick": 15,
            "start": {"x": 809.5822496304128, "y": 194},
            "end": {"x": 809.5822496304128, "y": 734},
            "type": "normal",
            "parent": Math.round(Math.random() * 500),
            "child": null,
            "angle": 1.5707963267948966,
            "equations": {
                "up": {"A": "v", "B": 819.5822496304128},
                "down": {"A": "v", "B": 799.5822496304128},
                "base": {"A": "v", "B": 809.5822496304128}
            },
            "coords": [{"x": 819.5822496304128, "y": 194}, {"x": 799.5822496304128, "y": 194}, {
                "x": 799.5822496304128,
                "y": 734
            }, {"x": 819.5822496304128, "y": 734}],
            "backUp": false,
            "graph": {"0": {}, "context": {}, "length": 1}
        });
